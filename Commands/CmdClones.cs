...
{
	public class CmdClones2 : Command
	{
		public override string name { get { return "clones2"; } }
		public override string shortcut { get { return  "alts2"; } }
        ...
        {
            get { return new[] { new CommandAlias("WhoIP2") }; }
        }
