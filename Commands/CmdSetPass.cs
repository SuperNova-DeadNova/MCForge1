    ...
    public class CmdSetPass : Command
    {
        ...
        public override void Use(Player p, string message)
        {
            ...
            if (p.adminpen)
            {
                ...
                {
                    Player.SendMessage(p, "&cYou already have a password set. " + Server.DefaultColor + "You &ccannot change " + Server.DefaultColor + "it unless &cyou verify it with &a/pass [Password]. " + Server.DefaultColor + "If you have &cforgotten " + Server.DefaultColor + "your password, contact &c" + Server.Owner + Server.DefaultColor + " and they can &creset it!");
                    return;
                }
            }
